...
<%	Integer ii=null;
	...
	Integer ts=null;
	Integer as=null;
	ii=Integer.valueOf(request.getParameter("i"));
	s=request.getParameter("st");
	e=request.getParameter("en");
	fa=Integer.valueOf(request.getParameter("f"));
	ts=Integer.valueOf(request.getParameter("t_seats"));
	as=Integer.valueOf(request.getParameter("a_seats"));
	...
	try {
		...
		prep = connect.prepareStatement("insert into mybus values (?,?,?,?,?,?)");
		prep.setInt(1,ii);
		prep.setString(2,s);
		prep.setString(3,e);
		prep.setInt(4,fa);
