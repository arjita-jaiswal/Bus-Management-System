...
<%
  ...
  try                                                                                       
  {
       br = new BufferedReader(new FileReader("C:\\eclipse-workspace\\jspdemo\\WebContent\\data.txt"));        // reding file into buffer  *****
       ...
       st.executeUpdate("drop table employee");//  create  statement  ******* 
